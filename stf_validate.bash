...
python validate.py root='' --dataset=seeingthroughfog_rgb --model efficientdetv2_dt --workers 4 --checkpoint output/train/20230604-155229-efficientdetv2_dt/model_best.pth.tar --num-classes=4 -b 1 --results rgb_test_clear_easy.txt --split val --img-size 1280
